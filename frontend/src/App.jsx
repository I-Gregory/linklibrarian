...
function App() {
  ...
  const API_BASE_URL = 'http://localhost:3001'; // Base URL for the deployed backend API. Change this to 'http://'https://linklibrarian-production.up.railway.app'' for public deployment.
